...
class Document
  ...
  APP_KEY = ""
  APP_SID = ""
  FILE_PATH = "../../TestData/DocumentElements/MathObjects/"
  ...
  # Getting math object from document
  def render_math_object
    ...
    request = RenderMathObjectRequest.new filename, format, index
...
puts document.render_math_object