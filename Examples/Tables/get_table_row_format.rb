...
class Document
  ...
  # Getting table row format
  def get_table_row_format
    ...
    request = GetTableRowFormatRequest.new filename, 'sections/0/tables/2', index, folder
...
puts document.get_table_row_format