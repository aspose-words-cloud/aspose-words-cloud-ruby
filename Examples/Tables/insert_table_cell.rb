...
class Document
  ...
  # Inserting table cell
  def insert_table_cell
    ...
    request = InsertTableCellRequest.new filename, 'sections/0/tables/2/rows/0', folder, nil, nil, 
...
puts document.insert_table_cell