...
class Document
  ...
  # Getting table cell format
  def get_table_cell_format
    ...
    request = GetTableCellFormatRequest.new filename, 'sections/0/tables/2/rows/0', index, folder
...
puts document.get_table_cell_format