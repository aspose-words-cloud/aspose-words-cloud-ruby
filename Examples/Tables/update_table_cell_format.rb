...
class Document
  ...
  # Updating table cell format
  def update_table_cell_format
    ...
    request = UpdateTableCellFormatRequest.new filename, 'sections/0/tables/2/rows/0', index, folder, nil, 
                                                nil, nil, nil, nil, nil, format
...
puts document.update_table_cell_format