...
class Document
  ...
  # Getting drawing object ole data
  def get_document_drawing_object_ole_data
    ...
    request = GetDocumentDrawingObjectOleDataRequest.new filename, index, folder, :node_path => 'sections/0'
...
puts document.get_document_drawing_object_ole_data