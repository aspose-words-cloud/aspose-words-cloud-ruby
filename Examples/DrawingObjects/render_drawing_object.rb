...
class Document
  ...
  # Rendering drawing object
  def render_drawing_object
    ...
    request = RenderDrawingObjectRequest.new filename, format, index, folder, :node_path => 'sections/0'
...
puts document.render_drawing_object