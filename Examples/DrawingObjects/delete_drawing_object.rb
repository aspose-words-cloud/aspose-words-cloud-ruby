...
class Document
  ...
  # Removing drawing object from document
  def delete_drawing_object
    ...
    request = DeleteDrawingObjectRequest.new filename, index
...
puts document.delete_drawing_object