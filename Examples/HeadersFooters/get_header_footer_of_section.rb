...
class Document
  ...
  # Getting section headers/footers
  def get_header_footer_of_section
    ...
    request = GetHeaderFooterOfSectionRequest.new filename, index, section_index
...
puts document.get_header_footer_of_section