...
class Document
  ...
  # Getting paragraph format
  def get_document_paragraph_format
    ...
    request = GetDocumentParagraphFormatRequest.new filename, index, folder
...
puts document.get_document_paragraph_format