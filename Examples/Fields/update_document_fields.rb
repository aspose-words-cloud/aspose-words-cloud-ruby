...
class Document
  ...
  # Reevaluating fields in document
  def update_document_fields
    filename = 'test_multi_pages.docx'
    folder = nil # File is at the root of the storage

    # Upload source document to Cloud Storage
    upload_file(filename)

    request = PostUpdateDocumentFieldsRequest.new filename, folder
...
puts document.update_document_fields