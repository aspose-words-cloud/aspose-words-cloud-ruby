...
class Document
  ...
  # Rejecting all revisions
  def reject_all_revisions
    filename = 'test_doc.docx'
    dest_name = 'TestRejectAllRevisions.docx'
    folder = nil # Source document is saved at the root of the storage

    # Upload source document to Cloud Storage
    upload_file(filename)

    request = RejectAllRevisionsRequest.new filename, folder, :dest_file_name => dest_name
...
puts document.reject_all_revisions