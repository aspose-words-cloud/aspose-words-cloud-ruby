...
Gem::Specification.new do |s|
  ...
  s.summary     = %q{Ruby library for communicating with the Aspose.Words Cloud API}
  s.description = %q{This SDK allows you to work with Aspose.Words Cloud REST APIs in your Ruby applications quickly and easily, with zero initial cost}
  s.license     = "MIT"
